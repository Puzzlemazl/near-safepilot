...
const ALLOWED_TOKENS = ["NEAR", "USDT", "USDC", "ETH", "WBTC", "AURORA", "LINEAR", "STNEAR", "META", "NEARX"];
  ...
  try {
    ...
    if (accountId) {
      ...
      if (linBal && parseFloat(linBal) > 1000000) {
          // FIX: Increased precision to 6 decimals
    ...
    // --- B. META POOL ---
    options.push({
        id: "meta-stake", name: "META POOL", subName: "Liquid Staking", apy: "10.12%", 
        min: 1.0, 
        risk: "LOW",
    ...
    // --- C. STADER ---
    options.push({
        id: "stader-stake", name: "STADER", subName: "NearX Yield", apy: "9.6%", 
        min: 1.0, 
        risk: "LOW",
